...
class SyncService extends RoboService
  ...
  protected[cloudr] lazy val syncAdapter = new CloudAppSyncAdapter
  ...
  protected[cloudr] class CloudAppSyncAdapter extends AbstractThreadedSyncAdapter(SyncService.this, true) {
